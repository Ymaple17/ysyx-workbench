...
object INST_Control{
  ...
  //               |               |                 |                |           |          |        |        |         |        |         |         |          |       |           |        |             |                |
    ...
    MULH  -> List(JUMP_NONE, NONE_MEM_WRITE, REG_WRITE     , NONE_CSR_WRITE, ALU_A_RD1 , ALU_B_RD2 , ImmX, ALU_MULH, NONE_VALID, RNONE  , WNONE , ALU_SEL , CSR_NONE, NONE_IRQ, IRQ_NONE, NONE_FENCEI, REG1_READ     , REG2_READ),
    MULHSU-> List(JUMP_NONE, NONE_MEM_WRITE, REG_WRITE     , NONE_CSR_WRITE, ALU_A_RD1 , ALU_B_RD2 , ImmX, ALU_MULHSU, NONE_VALID, RNONE  , WNONE , ALU_SEL , CSR_NONE, NONE_IRQ, IRQ_NONE, NONE_FENCEI, REG1_READ     , REG2_READ),
    MULHU -> List(JUMP_NONE, NONE_MEM_WRITE, REG_WRITE     , NONE_CSR_WRITE, ALU_A_RD1 , ALU_B_RD2 , ImmX, ALU_MULHU, NONE_VALID, RNONE  , WNONE , ALU_SEL , CSR_NONE, NONE_IRQ, IRQ_NONE, NONE_FENCEI, REG1_READ     , REG2_READ),
    
    //DIV
    DIV   -> List(JUMP_NONE, NONE_MEM_WRITE, REG_WRITE     , NONE_CSR_WRITE, ALU_A_RD1 , ALU_B_RD2 , ImmX, ALU_DIV , NONE_VALID, RNONE  , WNONE , ALU_SEL , CSR_NONE, NONE_IRQ, IRQ_NONE, NONE_FENCEI, REG1_READ     , REG2_READ),
    DIVU  -> List(JUMP_NONE, NONE_MEM_WRITE, REG_WRITE     , NONE_CSR_WRITE, ALU_A_RD1 , ALU_B_RD2 , ImmX, ALU_DIVU, NONE_VALID, RNONE  , WNONE , ALU_SEL , CSR_NONE, NONE_IRQ, IRQ_NONE, NONE_FENCEI, REG1_READ     , REG2_READ),
    REM   -> List(JUMP_NONE, NONE_MEM_WRITE, REG_WRITE     , NONE_CSR_WRITE, ALU_A_RD1 , ALU_B_RD2 , ImmX, ALU_REM , NONE_VALID, RNONE  , WNONE , ALU_SEL , CSR_NONE, NONE_IRQ, IRQ_NONE, NONE_FENCEI, REG1_READ     , REG2_READ),
    REMU  -> List(JUMP_NONE, NONE_MEM_WRITE, REG_WRITE     , NONE_CSR_WRITE, ALU_A_RD1 , ALU_B_RD2 , ImmX, ALU_REMU, NONE_VALID, RNONE  , WNONE , ALU_SEL , CSR_NONE, NONE_IRQ, IRQ_NONE, NONE_FENCEI, REG1_READ     , REG2_READ)
    )
}
...
class EXU_signals extends Bundle{
    ...
    val alu_control = Output(UInt(5.W))
