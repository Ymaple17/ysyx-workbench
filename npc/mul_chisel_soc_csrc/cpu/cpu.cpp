...
void exec_once(){
  ...
  if (rst_done) {
    uint8_t ifu_state = top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__core__DOT__ifu__DOT__state;
...
static void execute(uint64_t n) {
  ...
  for (; n > 0; n--) {
    if (!Verilated::gotFinish()) {
      ...
      bool lsu_valid = top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__core__DOT___lsu_io_out_valid;
