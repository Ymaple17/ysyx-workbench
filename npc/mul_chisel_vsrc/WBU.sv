...
module WBU(
  input         io_in_bits_signals_wbu_reg_write,
  ...
  wire [3:0][31:0] _GEN =
    {{io_in_bits_pc}, {io_in_bits_rd1 | io_in_bits_csr_rd1}, {io_in_bits_rd1}, {32'h0}};
  Ebreak ebreak (
  ...
  assign io_refile_wen = io_in_bits_signals_wbu_reg_write;
  assign io_csr_wdata = _GEN[io_in_bits_signals_wbu_csr_sel];
  assign io_csr_waddr = io_in_bits_csr_waddr;
  assign io_csr_wen = io_in_bits_signals_wbu_csr_write;
endmodule
