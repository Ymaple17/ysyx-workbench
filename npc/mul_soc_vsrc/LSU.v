...
module MEM (
    ...
    output reg [31:0] mem_fault_addr,
    ...
    assign shifted_rdata = sram_rdata >> (addr_offset_reg * 8);
                ...
                IDLE: begin
                    ...
                    if(ex_valid && mem_ready) begin//mem和上游ex握手
                        ...
                        if(MemRead) begin
                            ...
                            sram_awaddr <= addr;
                            sram_awvalid <= 1'b1;
                            sram_wdata <= data_in << (addr_offset * 8);
                            case(MemLen)
                                `Mem_Bit:  sram_wstrb <= 4'b0001 << addr_offset;//sb
                                `Mem_Half: sram_wstrb <= 4'b0011 << addr_offset;//sh
