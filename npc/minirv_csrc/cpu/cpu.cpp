...
void exec_once(){
    ...
    #ifdef CONFIG_ITRACE 
        if(top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__wb_valid && !top->reset){
        uint32_t current_inst = top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__inst;
