...
object PerfEvents {
  ...
  val EVENT_TRACE_HIT = 137.U(32.W)
  val EVENT_BP_RECOVER_CAPTURE_CYCLE = 138.U(32.W)
  val EVENT_BP_RECOVER_FQ_CYCLE = 139.U(32.W)
  val EVENT_BP_RECOVER_STALE_CYCLE = 140.U(32.W)
  val EVENT_BP_RECOVER_ICACHE_CYCLE = 141.U(32.W)
  val EVENT_BP_RECOVER_RESOURCE_CYCLE = 142.U(32.W)
  val EVENT_BP_RECOVER_CAPTURE_DONE = 143.U(32.W)
  val EVENT_BP_RECOVER_FQ_DONE = 144.U(32.W)
  val EVENT_STORE_ADDR_CANDIDATE_CYCLE = 145.U(32.W)
  val EVENT_STORE_ADDR_DATA_WAIT_SLOT = 146.U(32.W)
  val EVENT_STORE_DATA_ADDR_WAIT_SLOT = 147.U(32.W)
  val EVENT_STORE_READY_BLOCKED_CYCLE = 148.U(32.W)
  val EVENT_STORE_ISSUE = 149.U(32.W)
  val EVENT_STORE_ADDR_DUAL_LOAD_OPPORTUNITY = 150.U(32.W)
  val EVENT_STORE_ADDR_SIDECAR_ISSUE = 151.U(32.W)
  val EVENT_STORE_ADDR_SIDECAR_RESOLVE = 152.U(32.W)
  val EVENT_RETIRE_PATH_FLUSH = 153.U(32.W)
}
