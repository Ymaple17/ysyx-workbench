...
module ysyx_25020039_ICache(
  ...
  wire [26:0] tagA = io_in_arvalid ? io_in_araddr[31:5] : in_addr[31:5];
  ...
  wire        _GEN_0 = casez_tmp_0 & casez_tmp_1 == tagA;
  assign hit = _GEN_0 & io_in_arvalid;
  wire [31:0] _io_in_rdata_T_4 =
    hit & state != 3'h2
      ? (_GEN_0 ? (offset[2] ? casez_tmp_3 : casez_tmp_2) : 32'h0)
  ...
  assign _GEN =
    offset[2]
      ? (_GEN_3 ? io_out_rdata : casez_tmp_3)
      : _GEN_3 ? casez_tmp_2 : io_out_rdata;
  wire        _GEN_4 = _io_in_arready_T & fence_cnt == 2'h0;
  wire        _GEN_5 = _io_in_arready_T & fence_cnt == 2'h1;
  wire        _GEN_6 = _io_in_arready_T & fence_cnt == 2'h2;
  wire        _GEN_7 = _io_in_arready_T & (&fence_cnt);
  wire        _GEN_8 = io_out_rvalid & index == 2'h0;
  wire        _GEN_9 = io_out_rvalid & index == 2'h1;
  wire        _GEN_10 = io_out_rvalid & index == 2'h2;
  wire        _GEN_11 = io_out_rvalid & (&index);
  always @(posedge clock) begin
    if (reset) begin
      count <= 4'h2;
      icache_0_set_0_valid <= 1'h0;
      icache_0_set_0_tag <= 27'h0;
      icache_0_set_0_data_0 <= 32'h0;
      icache_0_set_0_data_1 <= 32'h0;
      icache_1_set_0_valid <= 1'h0;
      icache_1_set_0_tag <= 27'h0;
      icache_1_set_0_data_0 <= 32'h0;
      icache_1_set_0_data_1 <= 32'h0;
      icache_2_set_0_valid <= 1'h0;
      icache_2_set_0_tag <= 27'h0;
      icache_2_set_0_data_0 <= 32'h0;
      icache_2_set_0_data_1 <= 32'h0;
      icache_3_set_0_valid <= 1'h0;
      icache_3_set_0_tag <= 27'h0;
      ...
      if (_next_state_T_13)
        ...
        count <= count - 4'h1;
      icache_0_set_0_valid <= _GEN_8 | ~_GEN_4 & icache_0_set_0_valid;
      if (_GEN_8) begin
      ...
      icache_1_set_0_valid <= _GEN_9 | ~_GEN_5 & icache_1_set_0_valid;
      if (_GEN_9) begin
      ...
      icache_2_set_0_valid <= _GEN_10 | ~_GEN_6 & icache_2_set_0_valid;
      if (_GEN_10) begin
      ...
      icache_3_set_0_valid <= _GEN_11 | ~_GEN_7 & icache_3_set_0_valid;
      if (_GEN_11) begin
...
module ysyx_25020039_Xbar(
  ...
  wire       _GEN_3 = _next_state_T_15 ? is_imem : _next_state_T_17;
  wire [1:0] _GEN_4 = {1'h0, _next_state_T_19};
  wire       _GEN_5 =
    _next_state_T_15 ? _GEN_2 | ~is_dmem : _next_state_T_17 | ~_next_state_T_19;
  wire       _GEN_6 = _next_state_T_17 | _next_state_T_19;
  always @(posedge clock) begin
    if (reset)
      state <= 3'h0;
    else
  ...
  assign io_dmem_rresp = _GEN_5 ? 2'h0 : io_soc_rresp;
  ...
  assign io_dmem_bresp = _GEN_5 ? 2'h0 : io_soc_bresp;
  ...
  assign io_soc_arburst =
    _next_state_T_15
      ...
      : _next_state_T_17 ? io_imem_arburst : _GEN_4;
  ...
  assign io_soc_awsize = _GEN_5 ? 3'h0 : io_dmem_awsize;
  assign io_soc_awburst =
    _next_state_T_15 ? (_GEN_2 ? 2'h0 : _GEN_1) : _next_state_T_17 ? 2'h0 : _GEN_4;
  ...
  assign io_clint_araddr =
    (_next_state_T_15 ? is_imem | ~_GEN : _GEN_6 | ~_next_state_T_21)
      ? 32'h0
      : io_dmem_araddr;
  assign io_clint_arvalid =
    _next_state_T_15
      ? ~is_imem & _GEN & io_dmem_arvalid
      : ~_GEN_6 & _next_state_T_21 & io_dmem_arvalid;
  assign io_clint_rready =
    _next_state_T_15
      ? ~is_imem & _GEN & io_dmem_rready
      : ~_GEN_6 & _next_state_T_21 & io_dmem_rready;
endmodule
