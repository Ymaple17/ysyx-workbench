...
module ysyx_25020039_ICache(
  ...
  wire        _GEN_2 = 1'h0 - (count[0] - 1'h1);
  assign _GEN =
    offset[2]
      ? (_GEN_2 ? io_out_rdata : casez_tmp_3)
      : _GEN_2 ? casez_tmp_2 : io_out_rdata;
  wire        _GEN_3 = _io_in_arready_T & fence_cnt == 2'h0;
  wire        _GEN_4 = _io_in_arready_T & fence_cnt == 2'h1;
  wire        _GEN_5 = _io_in_arready_T & fence_cnt == 2'h2;
  wire        _GEN_6 = _io_in_arready_T & (&fence_cnt);
  wire        _GEN_7 = io_out_rvalid & index == 2'h0;
  wire        _GEN_8 = io_out_rvalid & index == 2'h1;
  wire        _GEN_9 = io_out_rvalid & index == 2'h2;
  wire        _GEN_10 = io_out_rvalid & (&index);
  always @(posedge clock) begin
    if (reset) begin
      count <= 4'h2;
      ...
      if (_next_state_T_13)
        ...
        count <= count - 4'h1;
      icache_0_set_0_valid <= _GEN_7 | ~_GEN_3 & icache_0_set_0_valid;
      if (_GEN_7) begin
      ...
      icache_1_set_0_valid <= _GEN_8 | ~_GEN_4 & icache_1_set_0_valid;
      if (_GEN_8) begin
      ...
      icache_2_set_0_valid <= _GEN_9 | ~_GEN_5 & icache_2_set_0_valid;
      if (_GEN_9) begin
      ...
      icache_3_set_0_valid <= _GEN_10 | ~_GEN_6 & icache_3_set_0_valid;
      if (_GEN_10) begin
  ...
  assign io_in_rdata = _GEN_1 ? _io_in_rdata_T_4 : rdata;
