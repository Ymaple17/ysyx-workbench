...
static inline void out_of_bound(paddr_t addr) {
  ...
  printf("[npc]address = 0x%08x is out of bound of pmem [0x%08x, 0x%08x] at pc = 0x%08x", addr, PMEM_LEFT, PMEM_RIGHT, top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__ifu_pc);
  npc_state.state=NPC_ABORT;
}

static inline void out_of_mrom(paddr_t addr) {
  print_register_values();
  printf("[npc]address = 0x%08x is out of bound of mrom [0x%08x, 0x%08x] at pc = 0x%08x", addr, MROM_LEFT, MROM_RIGHT, top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__ifu_pc);
  npc_state.state=NPC_ABORT;
}

static inline void out_of_flash(paddr_t addr) {
  print_register_values();
  printf("[npc]address = 0x%08x is out of bound of flash [0x%08x, 0x%08x] at pc = 0x%08x", addr, FLASH_LEFT, FLASH_RIGHT, top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__ifu_pc);
  npc_state.state=NPC_ABORT;
}

static inline void out_of_psram(paddr_t addr) {
  print_register_values();
  printf("[npc]address = 0x%08x is out of bound of psram [0x%08x, 0x%08x] at pc = 0x%08x", addr, PSRAM_LEFT, PSRAM_RIGHT, top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__ifu_pc);
  npc_state.state=NPC_ABORT;
}
