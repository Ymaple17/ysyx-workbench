...
object INST_Control{
  ...
  //               |               |                 |                |           |          |        |        |         |        |         |         |          |       |           |        |             |                |
    ...
    ECALL -> List(JUMP_NONE, NONE_MEM_WRITE, NONE_REG_WRITE, CSR_WRITE     , ALU_A_NONE, ALU_B_NONE, ImmI, ALU_NONE, NONE_VALID, RNONE  , WNONE , NONE_SEL, CSR_PC  ,      IRQ, IRQECALL, NONE_FENCEI, NONE_REG1_READ, NONE_REG2_READ),
