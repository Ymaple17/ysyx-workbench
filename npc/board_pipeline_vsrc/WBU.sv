...
module WBU(
  ...
  always @(posedge clock) begin
    if (reset)
      ebreak_io_is_ebreak_REG <= 1'h0;
    else
      ebreak_io_is_ebreak_REG <= io_in_valid & io_in_bits_is_ebreak & ~io_is_flush;
  end // always @(posedge)
  Ebreak ebreak (
    .is_ebreak (ebreak_io_is_ebreak_REG)
  );
