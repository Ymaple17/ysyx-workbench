...
object INST_Control{
  ...
  //               |               |                 |                |           |          |        |        |         |        |         |         |          |       |           |        |             |                |
    ...
    LUI   -> List(JUMP_NONE, NONE_MEM_WRITE, REG_WRITE     , NONE_CSR_WRITE, ALU_A_NONE, ALU_B_IMM , ImmU, ALU_ADD , NONE_VALID, RNONE  , WNONE , ALU_SEL , CSR_NONE, NONE_IRQ, IRQ_NONE, NONE_FENCEI, NONE_REG1_READ, NONE_REG2_READ),
