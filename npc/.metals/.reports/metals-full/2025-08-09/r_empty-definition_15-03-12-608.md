error id: file://<WORKSPACE>/chisel_vsrc/src/main/scala/databundle.scala:ready.
file://<WORKSPACE>/chisel_vsrc/src/main/scala/databundle.scala
empty definition using pc, found symbol in pc: ready.
...
non-local guesses:
	 ...
	 -chisel3/left/ready#
	 -chisel3/left/ready().
	 -chisel3/util/left/ready.
	 -chisel3/util/left/ready#
	 -chisel3/util/left/ready().
	 -common/Consts.left.ready.
	 -common/Consts.left.ready#
	 -common/Consts.left.ready().
	 -left/ready.
	 -left/ready#
	 -left/ready().
	 -scala/Predef.left.ready.
	 -scala/Predef.left.ready#
	 -scala/Predef.left.ready().
offset: 1494
