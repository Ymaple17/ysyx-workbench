...
object PerfEvents {
  ...
  val EVENT_IFU_NO_PC         = 19.U(32.W)
  val EVENT_IFU_AR_BLOCK      = 20.U(32.W)
  val EVENT_IFU_FAST_BACKPRESSURE = 21.U(32.W)
  val EVENT_IFU_FLUSH_WAIT    = 22.U(32.W)
  val EVENT_IDU_RAW_STALL     = 23.U(32.W)
  val EVENT_LSU_LOAD_WAIT     = 24.U(32.W)
  val EVENT_LSU_STORE_WAIT    = 25.U(32.W)
  val EVENT_EXU_MUL_WAIT      = 26.U(32.W)
  val EVENT_EXU_DIV_WAIT      = 27.U(32.W)
}
