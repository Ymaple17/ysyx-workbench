...
void print_perf_stats(unsigned long long cycles) {
    ...
    printf("\n[Cycle Attribution]\n");
    printf("IFU no PC: %lld\n", counters[EVENT_IFU_NO_PC]);
    printf("IFU request blocked: %lld\n", counters[EVENT_IFU_AR_BLOCK]);
    printf("IFU fast-response backpressure: %lld\n", counters[EVENT_IFU_FAST_BACKPRESSURE]);
    printf("IFU flush wait: %lld\n", counters[EVENT_IFU_FLUSH_WAIT]);
    printf("IDU RAW stall: %lld\n", counters[EVENT_IDU_RAW_STALL]);
    printf("LSU load wait: %lld\n", counters[EVENT_LSU_LOAD_WAIT]);
    printf("LSU store wait: %lld\n", counters[EVENT_LSU_STORE_WAIT]);
    printf("EXU MUL wait: %lld\n", counters[EVENT_EXU_MUL_WAIT]);
    printf("EXU DIV wait: %lld\n", counters[EVENT_EXU_DIV_WAIT]);
