...
module Core(
  ...
  wire        dcache_io_earlyLoadCancel;
  wire        exuInputFlush;
  reg  [31:0] exuOperandRs2;
  reg  [31:0] exuOperandRs1;
  wire        _dcache_io_cpu_arready;
  wire [31:0] _dcache_io_cpu_rdata;
  wire [1:0]  _dcache_io_cpu_rresp;
  wire        _dcache_io_cpu_rvalid;
  wire        _dcache_io_cpu_awready;
  wire        _dcache_io_cpu_wready;
  wire [1:0]  _dcache_io_cpu_bresp;
  wire        _dcache_io_cpu_bvalid;
  wire        _dcache_io_earlyLoad_ready;
  wire        _dcache_io_earlyLoadResp_valid;
  wire [31:0] _dcache_io_earlyLoadResp_bits_data;
  wire [1:0]  _dcache_io_earlyLoadResp_bits_resp;
  wire        _dcache_io_earlyLoadResp_bits_replay;
  ...
  wire        _lsu_io_earlyLoadResp_ready;
  wire        _lsu_io_loadResultValid;
  wire [31:0] _lsu_io_dmem_araddr;
  wire        _lsu_io_dmem_arvalid;
  wire [2:0]  _lsu_io_dmem_arsize;
  wire        _lsu_io_dmem_rready;
  wire [31:0] _lsu_io_dmem_awaddr;
  wire        _lsu_io_dmem_awvalid;
  wire [2:0]  _lsu_io_dmem_awsize;
  wire [31:0] _lsu_io_dmem_wdata;
  wire [3:0]  _lsu_io_dmem_wstrb;
  wire        _lsu_io_dmem_wvalid;
  wire        _lsu_io_dmem_bready;
  ...
  wire [31:0] _exu_io_out_bits_memory_address;
  ...
  wire [22:0] _idu_io_out_bits_bp_meta;
  ...
  wire [22:0] _ifu_io_out_bits_bp_meta;
  ...
  reg  [22:0] idu_io_in_bits_r_bp_meta;
  reg         idu_io_in_valid_r;
  wire        iduToExuFire = _idu_io_out_valid & _exu_io_in_ready;
  ...
  reg  [22:0] exu_io_in_bits_r_bp_meta;
  ...
  reg  [31:0] lsu_io_in_bits_r_memory_address;
  ...
  wire        exu_wen = exu_io_in_bits_r_signals_wbu_reg_write & exu_io_in_valid_r;
  wire        lsu_wen = lsu_io_in_bits_r_signals_wbu_reg_write & lsu_io_in_valid_r;
  wire        wbu_wen = wbu_io_in_bits_r_signals_wbu_reg_write & wbu_io_in_valid_r;
  ...
  wire        _earlyBaseExuHit_T = exu_wen & _idu_io_rs1_ren;
  wire        _earlyBaseExuHit_T_3 = _idu_io_refile_raddr1 == exu_io_in_bits_r_waddr;
  wire        idu_io_is_stall_exu_hit =
    _earlyBaseExuHit_T & (|_idu_io_refile_raddr1) & _earlyBaseExuHit_T_3;
  wire        _earlyBaseLsuHit_T = lsu_wen & _idu_io_rs1_ren;
  wire        _earlyBaseLsuHit_T_3 = _idu_io_refile_raddr1 == lsu_io_in_bits_r_waddr;
  wire        _earlyBaseWbuHit_T = wbu_wen & _idu_io_rs1_ren;
  wire        _earlyBaseWbuHit_T_3 = _idu_io_refile_raddr1 == wbu_io_in_bits_r_waddr;
  wire        _forwardedRs2_exu_hit_T = exu_wen & _idu_io_rs2_ren;
  wire        _forwardedRs2_exu_hit_T_3 = _idu_io_refile_raddr2 == exu_io_in_bits_r_waddr;
  wire        idu_io_is_stall_exu_hit_1 =
    _forwardedRs2_exu_hit_T & (|_idu_io_refile_raddr2) & _forwardedRs2_exu_hit_T_3;
  wire        _forwardedRs2_lsu_hit_T = lsu_wen & _idu_io_rs2_ren;
  wire        _forwardedRs2_lsu_hit_T_3 = _idu_io_refile_raddr2 == lsu_io_in_bits_r_waddr;
  wire        _earlyExuAdd_T = exu_io_in_bits_r_signals_wbu_reg_write_sel != 3'h4;
  wire        earlyBaseExuHit =
    _earlyBaseExuHit_T & (|_idu_io_refile_raddr1) & _earlyBaseExuHit_T_3;
  wire        earlyBaseLsuHit =
    _earlyBaseLsuHit_T & (|_idu_io_refile_raddr1) & _earlyBaseLsuHit_T_3
    & ~earlyBaseExuHit;
  wire        earlyExuAdd =
    earlyBaseExuHit & _earlyExuAdd_T & exu_io_in_bits_r_signals_wbu_reg_write_sel == 3'h1
    & exu_io_in_bits_r_signals_exu_alu_control == 5'h0
    & _idu_io_out_bits_imm_ext == 32'h0;
  wire        dcache_io_earlyLoad_valid =
    iduToExuFire & _idu_io_out_bits_signals_lsu_mem_valid
    & ~_idu_io_out_bits_signals_lsu_mem_write
    & ~(exu_io_in_valid_r & exu_io_in_bits_r_signals_lsu_mem_valid
        & exu_io_in_bits_r_signals_lsu_mem_write) & ~earlyBaseLsuHit
    & (~earlyBaseExuHit | earlyExuAdd) & ~exuInputFlush & ~dcache_io_earlyLoadCancel;
  reg         exuLoadPreissued;
  reg         loadPreissued;
  reg         is_irq;
  ...
  wire [31:0] resolved_target =
    _is_ret_update_T
      ? _exu_io_pc_bits_pc4_rs2
      : exu_io_in_bits_r_signals_exu_jump == 4'hA
          ? _csr_io_read_mepc
          : _exu_io_pc_bits_pc4_imm;
  wire        mis_predict =
    is_jump
    & (is_ch != exu_io_in_bits_r_bp_taken | is_ch & exu_io_in_bits_r_bp_taken
       & exu_io_in_bits_r_bp_target != resolved_target);
  reg         is_fencei;
  reg  [31:0] fencei_pc;
  assign exuInputFlush = is_irq | mis_predict;
  wire        _idu_io_is_flush_T = is_irq | is_fencei;
  assign dcache_io_earlyLoadCancel = _idu_io_is_flush_T | mis_predict;
  reg         bpu_update_valid;
  reg         bpu_update_taken;
  reg  [31:0] bpu_update_pc;
  reg  [31:0] bpu_update_target;
  reg         bpu_update_is_branch;
  reg  [22:0] bpu_update_meta;
  reg         bpu_update_is_call;
  reg         bpu_update_is_ret;
  wire        forwardedRs1_exu_hit =
    _earlyBaseExuHit_T & (|_idu_io_refile_raddr1) & _earlyBaseExuHit_T_3 & _earlyExuAdd_T;
  wire        forwardedRs1_lsu_hit =
    _earlyBaseLsuHit_T & (|_idu_io_refile_raddr1) & _earlyBaseLsuHit_T_3
    & ~forwardedRs1_exu_hit;
  wire        forwardedRs2_exu_hit =
    _forwardedRs2_exu_hit_T & (|_idu_io_refile_raddr2) & _forwardedRs2_exu_hit_T_3
    & _earlyExuAdd_T;
  wire        forwardedRs2_lsu_hit =
    _forwardedRs2_lsu_hit_T & (|_idu_io_refile_raddr2) & _forwardedRs2_lsu_hit_T_3
    & ~forwardedRs2_exu_hit;
  always @(posedge clock) begin
    if (reset) begin
      ...
      idu_io_in_bits_r_bp_meta <= 23'h0;
      ...
      exu_io_in_bits_r_bp_meta <= 23'h0;
      ...
      lsu_io_in_bits_r_memory_address <= 32'h0;
      ...
      is_fencei <= 1'h0;
      fencei_pc <= 32'h0;
      bpu_update_valid <= 1'h0;
      bpu_update_taken <= 1'h0;
      bpu_update_pc <= 32'h0;
      bpu_update_target <= 32'h0;
      bpu_update_is_branch <= 1'h0;
      bpu_update_meta <= 23'h0;
      bpu_update_is_call <= 1'h0;
      bpu_update_is_ret <= 1'h0;
    end
    else begin
      ...
      if (_ifu_io_out_valid & _idu_io_in_ready) begin
        ...
        idu_io_in_bits_r_bp_meta <= _ifu_io_out_bits_bp_meta;
      end
      if (_idu_io_in_ready | dcache_io_earlyLoadCancel)
        idu_io_in_valid_r <= ~dcache_io_earlyLoadCancel & _ifu_io_out_valid;
      if (iduToExuFire) begin
        ...
        exu_io_in_bits_r_bp_meta <= _idu_io_out_bits_bp_meta;
        exu_io_in_bits_r_inst <= _idu_io_out_bits_inst;
        exuLoadPreissued <= _dcache_io_earlyLoad_ready & dcache_io_earlyLoad_valid;
        exuOperandRs1 <=
          forwardedRs1_exu_hit
            ? casez_tmp
            : forwardedRs1_lsu_hit
                ? casez_tmp_0
                : _earlyBaseWbuHit_T & (|_idu_io_refile_raddr1) & _earlyBaseWbuHit_T_3
                  & ~forwardedRs1_exu_hit & ~forwardedRs1_lsu_hit
                    ? _wbu_io_refile_wdata
                    : _idu_io_out_bits_rd1;
        exuOperandRs2 <=
          forwardedRs2_exu_hit
            ? casez_tmp
            : forwardedRs2_lsu_hit
                ? casez_tmp_0
                : wbu_wen & _idu_io_rs2_ren & (|_idu_io_refile_raddr2)
                  & _idu_io_refile_raddr2 == wbu_io_in_bits_r_waddr
                  & ~forwardedRs2_exu_hit & ~forwardedRs2_lsu_hit
                    ? _wbu_io_refile_wdata
                    : _idu_io_out_bits_rd2;
      end
      if (_exu_io_in_ready | exuInputFlush)
        exu_io_in_valid_r <= ~exuInputFlush & _idu_io_out_valid;
      if (_exu_io_out_valid & _lsu_io_in_ready) begin
        ...
        lsu_io_in_bits_r_memory_address <= _exu_io_out_bits_memory_address;
        ...
        loadPreissued <= exuLoadPreissued;
      end
      if (_lsu_io_in_ready | is_irq)
        lsu_io_in_valid_r <= ~is_irq & _exu_io_out_valid;
      ...
      wbu_io_in_valid_r <= ~is_irq & _lsu_io_out_valid;
      ...
      bpu_update_valid <= is_jump & exu_io_in_bits_r_signals_exu_jump != 4'hA;
      bpu_update_taken <= is_ch;
      bpu_update_pc <= exu_io_in_bits_r_pc;
      bpu_update_target <= resolved_target;
      bpu_update_is_branch <=
        is_jump
        & (exu_io_in_bits_r_signals_exu_jump == 4'h0
      ...
      bpu_update_meta <= exu_io_in_bits_r_bp_meta;
      bpu_update_is_call <=
  ...
  IFU ifu (
    ...
    .io_out_bits_bp_meta         (_ifu_io_out_bits_bp_meta),
    ...
    .io_is_flush                 (_idu_io_is_flush_T | mis_predict),
    .io_correct_pc
      (is_irq
         ? _csr_io_read_mtvec
         : mis_predict
             ? (is_ch ? resolved_target : _exu_io_pc_bits_pc4)
             : is_fencei ? fencei_pc + 32'h4 : 32'h0),
    .io_bpu_update_valid         (bpu_update_valid),
    .io_bpu_update_taken         (bpu_update_taken),
    .io_bpu_update_pc            (bpu_update_pc),
    .io_bpu_update_target        (bpu_update_target),
    .io_bpu_update_is_branch     (bpu_update_is_branch),
    .io_bpu_update_meta          (bpu_update_meta),
    .io_bpu_update_is_call       (bpu_update_is_call),
    .io_bpu_update_is_ret        (bpu_update_is_ret)
  );
  IDU idu (
    .io_in_ready                           (_idu_io_in_ready),
    .io_in_valid                           (idu_io_in_valid_r),
    ...
    .io_in_bits_bp_meta                    (idu_io_in_bits_r_bp_meta),
    ...
    .io_out_bits_bp_meta                   (_idu_io_out_bits_bp_meta),
    ...
    .io_is_stall
      (_earlyBaseLsuHit_T & (|_idu_io_refile_raddr1) & _earlyBaseLsuHit_T_3
       & ~idu_io_is_stall_exu_hit & lsu_is_load & ~_lsu_io_loadResultValid
       | idu_io_is_stall_exu_hit & exu_is_load | _forwardedRs2_lsu_hit_T
       & (|_idu_io_refile_raddr2) & _forwardedRs2_lsu_hit_T_3 & ~idu_io_is_stall_exu_hit_1
       & lsu_is_load & ~_lsu_io_loadResultValid | idu_io_is_stall_exu_hit_1
       & exu_is_load),
  ...
  EXU exu (
    ...
    .io_in_bits_rd1                        (exuOperandRs1),
    .io_in_bits_rd2                        (exuOperandRs2),
    ...
    .io_out_bits_memory_address            (_exu_io_out_bits_memory_address),
  ...
  LSU lsu (
    ...
    .io_in_bits_memory_address             (lsu_io_in_bits_r_memory_address),
    ...
    .io_loadPreissued                      (loadPreissued),
    .io_earlyLoadResp_ready                (_lsu_io_earlyLoadResp_ready),
    .io_earlyLoadResp_valid                (_dcache_io_earlyLoadResp_valid),
    .io_earlyLoadResp_bits_data            (_dcache_io_earlyLoadResp_bits_data),
    .io_earlyLoadResp_bits_resp            (_dcache_io_earlyLoadResp_bits_resp),
    .io_earlyLoadResp_bits_replay          (_dcache_io_earlyLoadResp_bits_replay),
    .io_loadResultValid                    (_lsu_io_loadResultValid),
    ...
    .io_dmem_awaddr                        (_lsu_io_dmem_awaddr),
    .io_dmem_awvalid                       (_lsu_io_dmem_awvalid),
    .io_dmem_awsize                        (_lsu_io_dmem_awsize),
    .io_dmem_awready                       (_dcache_io_cpu_awready),
    .io_dmem_wdata                         (_lsu_io_dmem_wdata),
    .io_dmem_wstrb                         (_lsu_io_dmem_wstrb),
    .io_dmem_wvalid                        (_lsu_io_dmem_wvalid),
    .io_dmem_wready                        (_dcache_io_cpu_wready),
    .io_dmem_bresp                         (_dcache_io_cpu_bresp),
    .io_dmem_bvalid                        (_dcache_io_cpu_bvalid),
    .io_dmem_bready                        (_lsu_io_dmem_bready),
    .io_is_flush                           (is_irq)
  );
  WBU wbu (
    .io_in_valid                          (wbu_io_in_valid_r),
  ...
  DCache dcache (
    ...
    .io_cpu_awaddr                (_lsu_io_dmem_awaddr),
    .io_cpu_awvalid               (_lsu_io_dmem_awvalid),
    .io_cpu_awsize                (_lsu_io_dmem_awsize),
    .io_cpu_awready               (_dcache_io_cpu_awready),
    .io_cpu_wdata                 (_lsu_io_dmem_wdata),
    .io_cpu_wstrb                 (_lsu_io_dmem_wstrb),
    .io_cpu_wvalid                (_lsu_io_dmem_wvalid),
    .io_cpu_wready                (_dcache_io_cpu_wready),
    .io_cpu_bresp                 (_dcache_io_cpu_bresp),
    .io_cpu_bvalid                (_dcache_io_cpu_bvalid),
    .io_cpu_bready                (_lsu_io_dmem_bready),
    .io_mem_araddr                (io_dmem_araddr),
    .io_mem_arvalid               (io_dmem_arvalid),
    .io_mem_arsize                (io_dmem_arsize),
    .io_mem_arburst               (io_dmem_arburst),
    .io_mem_arready               (io_dmem_arready),
    .io_mem_rdata                 (io_dmem_rdata),
    .io_mem_rresp                 (io_dmem_rresp),
    .io_mem_rvalid                (io_dmem_rvalid),
    .io_mem_rready                (io_dmem_rready),
    .io_mem_awaddr                (io_dmem_awaddr),
    .io_mem_awvalid               (io_dmem_awvalid),
    .io_mem_awsize                (io_dmem_awsize),
    .io_mem_awburst               (io_dmem_awburst),
    .io_mem_awready               (io_dmem_awready),
    .io_mem_wdata                 (io_dmem_wdata),
    .io_mem_wstrb                 (io_dmem_wstrb),
    .io_mem_wvalid                (io_dmem_wvalid),
    .io_mem_wlast                 (io_dmem_wlast),
    .io_mem_wready                (io_dmem_wready),
    .io_mem_bresp                 (io_dmem_bresp),
    .io_mem_bvalid                (io_dmem_bvalid),
    .io_mem_bready                (io_dmem_bready),
    .io_earlyLoad_ready           (_dcache_io_earlyLoad_ready),
    .io_earlyLoad_valid           (dcache_io_earlyLoad_valid),
    .io_earlyLoad_bits_addr
      (earlyExuAdd
         ? (exu_io_in_bits_r_signals_exu_alu_srcA == 2'h1
              ? exu_io_in_bits_r_pc
              : exuOperandRs1)
           + (exu_io_in_bits_r_signals_exu_alu_srcB == 2'h1
                ? exu_io_in_bits_r_imm_ext
                : exuOperandRs2)
         : (_earlyBaseWbuHit_T & (|_idu_io_refile_raddr1) & _earlyBaseWbuHit_T_3
            & ~earlyBaseExuHit & ~earlyBaseLsuHit
              ? _wbu_io_refile_wdata
              : _idu_io_out_bits_rd1) + _idu_io_out_bits_imm_ext),
    .io_earlyLoad_bits_size
      ({1'h0,
        _idu_io_out_bits_signals_lsu_mem_rd == 3'h5
          ? 2'h1
          : _idu_io_out_bits_signals_lsu_mem_rd == 3'h4
              ? 2'h0
              : _idu_io_out_bits_signals_lsu_mem_rd == 3'h3
                  ? 2'h2
                  : _idu_io_out_bits_signals_lsu_mem_rd == 3'h2
                      ? 2'h1
                      : {_idu_io_out_bits_signals_lsu_mem_rd != 3'h1, 1'h0}}),
    .io_earlyLoadResp_ready       (_lsu_io_earlyLoadResp_ready),
    .io_earlyLoadResp_valid       (_dcache_io_earlyLoadResp_valid),
    .io_earlyLoadResp_bits_data   (_dcache_io_earlyLoadResp_bits_data),
    .io_earlyLoadResp_bits_resp   (_dcache_io_earlyLoadResp_bits_resp),
    .io_earlyLoadResp_bits_replay (_dcache_io_earlyLoadResp_bits_replay),
    .io_earlyLoadCancel           (dcache_io_earlyLoadCancel)
  );
endmodule
