...
object Master_Slave{
    def AR_connect(master: AXI4Master, slave: AXI4Slave): Unit = {
    ...
    def R_connect(master: AXI4Master, slave: AXI4Slave): Unit = {
    ...
    def AW_connect(master: AXI4Master, slave: AXI4Slave): Unit = {
    ...
    def W_connect(master: AXI4Master, slave: AXI4Slave): Unit = {
    ...
    def B_connect(master: AXI4Master, slave: AXI4Slave): Unit = {
    ...
    def ALL_connect(master: AXI4Master, slave: AXI4Slave): Unit = {
        AR_connect(master, slave)
        R_connect(master, slave)
        AW_connect(master, slave)
        W_connect(master, slave)
        B_connect(master, slave)
    }
}

object Slave_Master{
    def AR_connect(slave: AXI4Slave, master: AXI4Master): Unit = {
    ...
    def R_connect(slave: AXI4Slave, master: AXI4Master): Unit = {
    ...
    def AW_connect(slave: AXI4Slave, master: AXI4Master): Unit = {
    ...
    def W_connect(slave: AXI4Slave, master: AXI4Master): Unit = {
    ...
    def B_connect(slave: AXI4Slave, master: AXI4Master): Unit = {
    ...
    def ALL_connect(slave: AXI4Slave, master: AXI4Master): Unit = {
        AR_connect(slave, master)
        R_connect(slave, master)
        AW_connect(slave, master)
        W_connect(slave, master)
        B_connect(slave, master)
    }
}
