...
extern "C" void sim_exit(){
    ...
    set_npc_state(NPC_END, top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__ifu_pc, cpu_gpr[10]);
}
...
static inline void update_cpu_state() {
    cpu.pc = top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__ifu_pc;
    //printf("%08x\n", cpu.pc);
    for(int i = 0; i < 32; i++){
...
void exec_once(){
    if (!rst_done) {
        ...
        itrace_inst(top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__ifu_pc, current_inst);
        display_inst();
    #endif
        ...
        case NPC_END: 
            if(npc_state.halt_ret == 0){
                ...
                printf("npc: " ANSI_FG_GREEN "%s" ANSI_RESET " at pc = 0x%08x\n", 
                       out, top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__ifu_pc); 
            }
            else{
                out = (char *)"ABORT";
                #ifdef CONFIG_DIFFTEST
