...
module BranchIssueQueue(
  ...
  output [1:0]  io_issue_bits_cp_idx,
  ...
  assign io_issue_bits_cp_idx =
    (|_residentIssueValid_T) ? casez_tmp_0 : io_enq_bits_cp_idx;
  assign io_issue_bits_src1_phys =
    (|_residentIssueValid_T) ? casez_tmp_1 : io_enq_bits_src1_phys;
  assign io_issue_bits_src2_phys =
    (|_residentIssueValid_T) ? casez_tmp_2 : io_enq_bits_src2_phys;
  assign io_issue_bits_src1_val =
    (|_residentIssueValid_T) ? casez_tmp_3 : enqView_src1_val;
  assign io_issue_bits_src2_val =
    (|_residentIssueValid_T) ? casez_tmp_4 : enqView_src2_val;
  assign io_issue_bits_pdest = (|_residentIssueValid_T) ? casez_tmp_5 : io_enq_bits_pdest;
  assign io_issue_bits_do_rename =
    (|_residentIssueValid_T) ? casez_tmp_6 : io_enq_bits_do_rename;
  assign io_issue_bits_pc = (|_residentIssueValid_T) ? casez_tmp_7 : io_enq_bits_pc;
  assign io_issue_bits_inst = (|_residentIssueValid_T) ? casez_tmp_8 : io_enq_bits_inst;
  assign io_issue_bits_imm_ext =
    (|_residentIssueValid_T) ? casez_tmp_9 : io_enq_bits_imm_ext;
  assign io_issue_bits_waddr =
    (|_residentIssueValid_T) ? casez_tmp_10 : io_enq_bits_waddr;
  assign io_issue_bits_csr_rd1 =
    (|_residentIssueValid_T) ? casez_tmp_11 : io_enq_bits_csr_rd1;
  assign io_issue_bits_state_state =
    (|_residentIssueValid_T) ? casez_tmp_12 : io_enq_bits_state_state;
  assign io_issue_bits_state_state_num =
    (|_residentIssueValid_T) ? casez_tmp_13 : io_enq_bits_state_state_num;
  assign io_issue_bits_bp_valid =
    (|_residentIssueValid_T) ? casez_tmp_14 : io_enq_bits_bp_valid;
  assign io_issue_bits_bp_taken =
    (|_residentIssueValid_T) ? casez_tmp_15 : io_enq_bits_bp_taken;
  assign io_issue_bits_bp_target =
    (|_residentIssueValid_T) ? casez_tmp_16 : io_enq_bits_bp_target;
  assign io_issue_bits_bp_index =
    (|_residentIssueValid_T) ? casez_tmp_17 : io_enq_bits_bp_index;
  assign io_issue_bits_ftq_idx =
    (|_residentIssueValid_T) ? casez_tmp_18 : io_enq_bits_ftq_idx;
  assign io_issue_bits_ftq_generation =
    (|_residentIssueValid_T) ? casez_tmp_19 : io_enq_bits_ftq_generation;
  assign io_issue_bits_exu_alu_srcA =
    (|_residentIssueValid_T) ? casez_tmp_20 : io_enq_bits_exu_alu_srcA;
  assign io_issue_bits_exu_alu_srcB =
    (|_residentIssueValid_T) ? casez_tmp_21 : io_enq_bits_exu_alu_srcB;
  assign io_issue_bits_exu_alu_control =
    (|_residentIssueValid_T) ? casez_tmp_22 : io_enq_bits_exu_alu_control;
  assign io_issue_bits_exu_jump =
    (|_residentIssueValid_T) ? casez_tmp_23 : io_enq_bits_exu_jump;
  assign io_issue_bits_lsu_mem_rd =
    (|_residentIssueValid_T) ? casez_tmp_24 : io_enq_bits_lsu_mem_rd;
  assign io_issue_bits_lsu_mem_write =
    (|_residentIssueValid_T) ? casez_tmp_25 : io_enq_bits_lsu_mem_write;
  assign io_issue_bits_lsu_mem_valid =
    (|_residentIssueValid_T) ? casez_tmp_26 : io_enq_bits_lsu_mem_valid;
  assign io_issue_bits_wbu_reg_write =
    (|_residentIssueValid_T) ? casez_tmp_27 : io_enq_bits_wbu_reg_write;
  assign io_issue_bits_wbu_reg_write_sel =
    (|_residentIssueValid_T) ? casez_tmp_28 : io_enq_bits_wbu_reg_write_sel;
endmodule
